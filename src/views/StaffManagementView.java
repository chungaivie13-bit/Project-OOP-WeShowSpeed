...
public class StaffManagementView extends JPanel {
    ...
    private JPanel createAddPanel() {
        ...
        addRoleComboBox  = new JComboBox<>(new String[]{"Admin", "Manager", "Staff"});
    ...
    private JPanel createViewPanel() {
        ...
        deleteButton.addActionListener((ActionEvent e) -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                if (deleted) {
                    staffController.renumberStaffIds();
    ...
    private JPanel createUpdatePanel() {
        ...
        updateRoleComboBox  = new JComboBox<>(new String[]{"Admin", "Manager", "Staff"});
