...
public class DashboardView extends JFrame {
    ...
    public DashboardView(Staff loggedInStaff) {
        ...
        cardPanel.add(new StaffManagementView(), "Staff");
        // Placeholders for other modules
        cardPanel.add(new JPanel() {{ add(new JLabel("Materials Module Coming Soon")); }}, "Materials");
        cardPanel.add(new JPanel() {{ add(new JLabel("Customers Module Coming Soon")); }}, "Customers");
        cardPanel.add(new JPanel() {{ add(new JLabel("Suppliers Module Coming Soon")); }}, "Suppliers");
